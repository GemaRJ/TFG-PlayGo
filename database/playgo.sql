...
VALUES (1, 3, 1, 23, '2026-03-05 13:16:38'),
...
VALUES (
    ...
    'Equipo PlayGo',
    'admin@playgo.com',
    '$2a$10$vY37nlRiKR7X30hzsOhi7.ce75hyMIL54KVo4mBVfF9W8epa4Gn9K',
    'administrador',
    '2026-02-09 18:49:25'
  ),
  (
  ...
  (
    ...
    'Leo',
    'leo@playgo.com',
    '$2y$10$cH2ddbqnH8QivnwfMeRQJe4dN2D8d9bIXC9a8abvi2BeXLmJ1IYUy',
    'nino',
    '2026-02-17 13:29:19'
  );
--
...
--
ALTER TABLE `incidencias`
ADD CONSTRAINT `fk_usuario_incidencia` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`usuario_id`) ON DELETE
SET NULL;
--
