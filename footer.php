<footer class="playgo-footer">
    ...
    <div class="footer-inner">
        ...
        <div class="footer-brand">
            <div class="footer-logo">
                ...
                <span class="logo-text">Play<span class="logo-accent">Go</span></span>
            </div>
            <p class="footer-tagline">Tu universo de juegos en la nube.</p>
        </div>
        ...
        <div class="footer-team">
            ...
            <ul class="footer-team-list">
                <li><span class="team-dot" aria-hidden="true"></span>Gema Rodriguez Jorge </li>
                <li><span class="team-dot" aria-hidden="true"></span>Patricia Jimenez Berzal</li>
                <li><span class="team-dot" aria-hidden="true"></span>Sofía Fabiana Daniele</li>
            </ul>
            <p class="footer-school">DAW · <?php echo date('Y'); ?></p>
        </div>
    ...
    <div class="footer-bottom">
        <p>&copy; <?php echo date('Y'); ?> PlayGo. Proyecto educativo sin fines comerciales.</p>
